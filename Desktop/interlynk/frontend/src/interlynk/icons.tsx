...
export const Ic = {
  ...
  Calendar: sv(<><rect width="18" height="18" x="3" y="4" rx="2" ry="2" /><line x1="16" x2="16" y1="2" y2="6" /><line x1="8" x2="8" y1="2" y2="6" /><line x1="3" x2="21" y1="10" y2="10" /></>),
  Clock: sv(<><circle cx="12" cy="12" r="10" /><polyline points="12 6 12 12 16 14" /></>),
  CheckCheck: sv(<><path d="M18 6 7 17l-3-3" /><path d="m22 10-7.5 7.5L13 16" /></>),
  Image: sv(<><rect width="18" height="18" x="3" y="3" rx="2" ry="2" /><circle cx="9" cy="9" r="2" /><path d="m21 15-3.086-3.086a2 2 0 0 0-2.828 0L6 21" /></>),
  File: sv(<><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" /><path d="M14 2v6h6" /></>),
  Play: sv(<polygon points="6 3 20 12 6 21 6 3" />),
  Pause: sv(<><rect x="6" y="4" width="4" height="16" rx="1" /><rect x="14" y="4" width="4" height="16" rx="1" /></>),
  Square: sv(<rect width="14" height="14" x="5" y="5" rx="2" />),
  Download: sv(<><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4" /><polyline points="7 10 12 15 17 10" /><line x1="12" x2="12" y1="15" y2="3" /></>),
  Gif: sv(<><rect width="18" height="14" x="3" y="5" rx="2" /><path d="M7 9.5a1.5 1.5 0 0 0-1.5 1.5v0a1.5 1.5 0 0 0 1.5 1.5h.5v-1.5" /><path d="M11 9.5v5" /><path d="M14.5 9.5h2.5M14.5 9.5v5M14.5 12h2" /></>),
  Volume: sv(<><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5" /><path d="M15.54 8.46a5 5 0 0 1 0 7.07" /></>),
  Languages: sv(<><path d="m5 8 6 6" /><path d="m4 14 6-6 2-3" /><path d="M2 5h12" /><path d="M7 2h1" /><path d="m22 22-5-10-5 10" /><path d="M14 18h6" /></>),
  Waveform: sv(<><path d="M2 12h2" /><path d="M6 8v8" /><path d="M10 5v14" /><path d="M14 7v10" /><path d="M18 9v6" /><path d="M22 11v2" /></>),
  BarChart: sv(<><line x1="12" x2="12" y1="20" y2="10" /><line x1="18" x2="18" y1="20" y2="4" /><line x1="6" x2="6" y1="20" y2="16" /></>),
  Poll: sv(<><rect width="20" height="16" x="2" y="4" rx="2" /><line x1="6" x2="14" y1="9" y2="9" /><line x1="6" x2="14" y1="13" y2="13" /><line x1="6" x2="10" y1="17" y2="17" /><circle cx="18" cy="9" r="1.4" fill="currentColor" /><circle cx="18" cy="13" r="1.4" fill="currentColor" /></>),
  Camera: sv(<><path d="M14.5 4h-5L7 7H4a2 2 0 0 0-2 2v9a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V9a2 2 0 0 0-2-2h-3l-2.5-3z" /><circle cx="12" cy="13" r="3.5" /></>),
  ...
  Upload: sv(<><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4" /><polyline points="17 8 12 3 7 8" /><line x1="12" x2="12" y1="3" y2="15" /></>),
